 ...
 */
@property(nonatomic, copy, readonly) NSString *connectingDeviceName;
/*! @brief
...
/*! @brief
 OTA设备 [OTA device]
 */
@property(nonatomic, strong, readonly) HwBluetoothDevice *otaDevice;
...
#pragma mark - 错误码处理
- (void) setHandler:(void(^)(HwBluetoothData *dataModel))handler
