...
/*
 dict[HwKeyReminderType] = @(type);
 dict[HwKeyReminderYear] = @(year);
 dict[HwKeyReminderMonth] = @(month);
 dict[HwKeyReminderDay] = @(day);
 dict[HwKeyReminderHour] = @(hour);
 dict[HwKeyReminderMin] = @(min);
 dict[HwKeyReminderWeek] = @(week);
 dict[HwKeyReminderState] = @(state);
 dict[HwKeyReminderVibration] = @(vib);
 */
